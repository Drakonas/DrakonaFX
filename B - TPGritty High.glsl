...
MaxValue = 1.0, 1.0, 1.0
StepAmount = 0.01, 0.01, 0.01
DefaultValue = 0.020, 0.040, 0.400
DependentOption = C_GAUSSIAN_ANAMFLARE
...
void Merger()
{
	...
	{
		value = Sample();
		/*if (OptionEnabled(I_FXAA_PASS)) { value = FxaaPass(value); }*/
		if (OptionEnabled(A_TEXTURE_SHARPEN)) { value = TexSharpenPass(value); }
		/*if (OptionEnabled(F_PIXEL_VIBRANCE)) { value = VibrancePass(value); }*/
